...
2. Now create a new script from File >> New File >> R Script. Save your new script under the name **session3**.
...
**Exercise 5**
Create a new script and name it **session3_iris**. Then type in and execute the right command in order to load the dataset **iris**
